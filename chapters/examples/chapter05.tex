...
Der Punkt Performance hat befriedigend bekommen, vier die neue Struktur diese eine Verbesserung ist, aber dies sich ändern kann. \textbf{\textcolor[rgb]{1,0,0}{Dies ist für mich kein verständlicher Satz.}}
Übersichtlich hat gut statt ein vollbefriedigend erhalten, weil selbst wenn es auch schwieriger ist übersichtlich zu sehen, welche Berechtigungen alle einem Profil zu geordnet wurden, ist es dennoch leichter herauszufinden, wer alles eine spezifische Berechtigungen hat. \textbf{\textcolor[rgb]{1,0,0}{Dies ist für mich kein verständlicher Satz.}}
