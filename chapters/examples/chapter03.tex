...
Dadurch soll der Leser ein Grundverständnis erlangen, um die folgenden Kapitel zu verstehen, sowie ein besseres Verständnis zum Themenbereich des Hosts zu erhalten.
...
Dabei definiert die \ac{NIST}, welche ein Institut der amerikanischen Regierung ist, Berechtigungen wie folgt:
\newline
\newline
...
\newline
\newline
\textit{"`Das Recht oder die Erlaubnis haben, um auf System Ressourcen einer Systemeinheit zuzugreifen."'} \cite{Mainframe}
\newline
\newline
