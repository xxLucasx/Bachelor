...
Neben den technische Herausforderunge und Anforderungen muss die Struktur neben dem \ac{VAIT} auch den Standards vom \ac{DSGVO} erfüllen.
Bei Verstoß dieser kann es zur Verwarnung bis zum endgültigen Verbot zum Verarbeiten von den Daten kommen. \cite{EuroK}
Dies würde die Helvetia sehr viel Geld kosten.
\newline
...
Deswegen sind Mitarbeiter, die mehr Berechtigungen, als die sie benötigen eine Risikostelle. \cite{EuroW}
\newline
