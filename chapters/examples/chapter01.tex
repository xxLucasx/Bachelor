...
Wobei man berücksichtigen muss, dass diese Befragung zwischen Januar and März stattgefunden und dies daher nur das erste Quartal von 2022 abdeckt.
...
Wenn dies nicht der Fall ist, kann es passieren, dass den jeweiligen Nutzern zu viele Berechtigungen haben und dies wäre wieder ein Problem bei Espionage oder Sabotage.
...
Diese Arbeit ist eine Vergleichsarbeit bei den verschiedenen Konzepte verglichen werden.
...
Anschließend wurden mehrere Befragungen durchgeführt, um den bestehenden Konzepten nach den Wünschen der Befragten anzupassen.
